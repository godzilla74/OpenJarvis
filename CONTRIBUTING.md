...
See the [Savings Leaderboard](https://godzilla74.github.io/OpenJarvis/leaderboard/) for details.
...
Look for issues labeled [`good-first-issue`](https://github.com/godzilla74/OpenJarvis/labels/good-first-issue).
...
1. Browse the [Roadmap](https://godzilla74.github.io/OpenJarvis/development/roadmap/) for an item that interests you
2. Check if a [GitHub issue](https://github.com/godzilla74/OpenJarvis/issues) already exists for it — if not, [open one](https://github.com/godzilla74/OpenJarvis/issues/new/choose) describing what you'd like to work on
...
Use the appropriate [issue template](https://github.com/godzilla74/OpenJarvis/issues/new/choose):
...
- Open a [Discussion](https://github.com/godzilla74/OpenJarvis/discussions) for questions and help
- Check the [documentation](https://godzilla74.github.io/OpenJarvis/) for guides and API reference
