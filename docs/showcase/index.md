...
4. **"How I set this up →"**: a link to the relevant [Tutorial](../tutorials/index.md), [User Guide](../user-guide/cli.md), or [Recipe](https://github.com/godzilla74/OpenJarvis/tree/main/src/openjarvis/recipes/data).
