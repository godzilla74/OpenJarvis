...
on launch / every 30 min
        │
        ▼
GET https://github.com/godzilla74/OpenJarvis/releases/download/desktop-latest/latest.json
        │
        ▼
...
curl -fsSL https://github.com/godzilla74/OpenJarvis/releases/download/desktop-latest/latest.json | jq .
